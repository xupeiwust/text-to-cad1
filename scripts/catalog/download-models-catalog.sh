...
function usage() {
  cat <<'EOF'
Usage:
  VIEWER_VERCEL_BLOB_PREFIX=<public-url-prefix> scripts/catalog/download-models-catalog.sh <target-dir> [--force]
...
function usage() {
  return `Usage:
  scripts/catalog/download-models-catalog.sh <target-dir> [--force]
